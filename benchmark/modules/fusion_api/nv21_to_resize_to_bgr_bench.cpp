...
BENCHMARK_DEFINE_F(NV212Resize2BGRBench, 720Pto480P)(benchmark::State& state) {
...
BENCHMARK_DEFINE_F(NV212Resize2BGRBench, 4Kto480P)(benchmark::State& state) {
...
BENCHMARK_REGISTER_F(NV212Resize2BGRBench, 720Pto480P)
...
BENCHMARK_REGISTER_F(NV212Resize2BGRBench, 4Kto480P)
        ->Unit(benchmark::kMicrosecond)
        ->Iterations(100)
        ->DenseRange(55, 255, 200);
