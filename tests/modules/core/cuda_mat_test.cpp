...
TEST_F(CudaMatTest, ConvertToPositiveInput) {
    CudaMat dst;
...
TEST_F(CudaMatTest, ConvertToNegativeInput) {
    CudaMat dst_gray_u8;
...
TEST_F(CudaMatTest, CopyToPositiveInput) {
    CudaMat dst;
...
TEST_F(CudaMatTest, CopyToWithMaskPositiveInput) {
