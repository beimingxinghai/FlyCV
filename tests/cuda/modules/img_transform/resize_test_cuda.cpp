...
protected:
    void SetUp() override {
        ...
        ASSERT_EQ(prepare_pkg_bgr_u8_720p_cuda(bgr_u8_src), 0);
        ASSERT_EQ(prepare_pkg_bgra_u8_720p_cuda(bgra_u8_src), 0);
        ASSERT_EQ(prepare_pkg_bgr_f32_720p_cuda(bgr_f32_src), 0);
    }
