...
class CudaMatAtTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(CudaMatAtTest, AtPositiveInput) {
...
TEST_F(CudaMatAtTest, AtNV21PositiveInput) {
...
TEST_F(CudaMatAtTest, AtI420PositiveInput) {
