 ...
 * @param[in] src source image, supported image type:CudaMat, the number of channel: 1 ,3.
 * @param[out] dst dst image, supported image type:CudaMat,the number of channel: 1 ,3
